...
try {
	...
	execSync(`${lernaPath} version ${target} --allow-branch=${branchName} --force-publish=* --no-changelog --yes`);
	...
	execSync(`${lernaPath} publish from-package --create-release github --yes`);
